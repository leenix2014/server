...
public final class RoomCardBill extends TableBase implements java.io.Serializable{
    // Serializable ID
    ...
    */
    ...
    // SQL templates
    private static final String _updateSQL = "UPDATE ROOM_CARD_BILL SET `USER_ID` = ?, `USER_NAME` = ?, `SOURCE` = ?, `SOURCE_ID` = ?, `SOURCE_NAME` = ?, `AMOUNT` = ?, `BEFORE_BAL` = ?, `AFTER_BAL` = ?, `CREATE_TIME` = ? WHERE `ID` = ?;";
    private static final String _querySQL = "SELECT * FROM ROOM_CARD_BILL WHERE `ID` = ?;";
    private static final String _createSQL = "INSERT INTO ROOM_CARD_BILL (`USER_ID`, `USER_NAME`, `SOURCE`, `SOURCE_ID`, `SOURCE_NAME`, `AMOUNT`, `BEFORE_BAL`, `AFTER_BAL`, `CREATE_TIME`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?);";
    private static final String _deleteSQL = "DELETE FROM ROOM_CARD_BILL WHERE `ID` = ?;";
    ...
    public static final TableBase.Attribute<Integer> AttrID = new TableBase.Attribute<Integer>("ID", RoomCardBill.class, 1);
    public static final TableBase.AttributeS AttrUSER_ID = new TableBase.AttributeS("USER_ID", RoomCardBill.class, 2);
    public static final TableBase.AttributeS AttrUSER_NAME = new TableBase.AttributeS("USER_NAME", RoomCardBill.class, 3);
    public static final TableBase.AttributeS AttrSOURCE = new TableBase.AttributeS("SOURCE", RoomCardBill.class, 4);
    public static final TableBase.AttributeS AttrSOURCE_ID = new TableBase.AttributeS("SOURCE_ID", RoomCardBill.class, 5);
    public static final TableBase.AttributeS AttrSOURCE_NAME = new TableBase.AttributeS("SOURCE_NAME", RoomCardBill.class, 6);
    public static final TableBase.Attribute<Integer> AttrAMOUNT = new TableBase.Attribute<Integer>("AMOUNT", RoomCardBill.class, 7);
    public static final TableBase.Attribute<Integer> AttrBEFORE_BAL = new TableBase.Attribute<Integer>("BEFORE_BAL", RoomCardBill.class, 8);
    public static final TableBase.Attribute<Integer> AttrAFTER_BAL = new TableBase.Attribute<Integer>("AFTER_BAL", RoomCardBill.class, 9);
    public static final TableBase.Attribute<java.util.Date> AttrCREATE_TIME = new TableBase.Attribute<java.util.Date>("CREATE_TIME", RoomCardBill.class, 10);
    ...
    public HashMap<String, Integer> _getFieldMap(){
        return RoomCardBill.getFieldMap();
    }
    ...
    */
    ...
    public static ArrayList<RoomCardBill> getAllObjects(){
        ArrayList<Object> __tmp = _tableCache.loadAll();

        ArrayList<RoomCardBill> __res = new ArrayList<RoomCardBill>();
        for (Object __obj: __tmp){
            __res.add((RoomCardBill)__obj);
        }
    ...
    */
    public static int updateBatch(RoomCardBill[] objList){
        Object[][] argv = new Object[objList.length][];

        for (int idx = 0; idx < objList.length; idx++){
            RoomCardBill o = objList[idx];
    ...
    */
    public static int removeBatch(RoomCardBill[] objList){
        Object argv[] = new Object[objList.length];
    ...
    */
    public static RoomCardBill create(){

        RoomCardBill __newObj = new RoomCardBill();

        return (RoomCardBill) _tableCache.create(__newObj, _createSQL, 
    ...
    */
    public static RoomCardBill getOne(int ID){
        return (RoomCardBill) _tableCache.getOne(_genKey(ID), _querySQL, ID);
    }
    ...
    * @return the found JPO or null
    */
    public static RoomCardBill getOneByCriteria(QueryCriteria ...criteria){
        return (RoomCardBill)_tableCache.getOneByCriteria(criteria);
    }
    ...
    */
    public static ArrayList<RoomCardBill> getManyByCriteria(QueryCriteria ...criteria){
    ...
    */
    public static RoomCardBill getOneBySQL(String sql, Object ...args){
        return (RoomCardBill)_tableCache.getOneBySQL(sql, args);
    }
    ...
    * @return a list of JPO found.
    */
    public static ArrayList<RoomCardBill> getManyBySQL(String sql, Object ...args){
