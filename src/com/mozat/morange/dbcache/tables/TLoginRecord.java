...
public final class TLoginRecord extends TableBase implements java.io.Serializable{
    // Serializable ID
    ...
    */
    ...
    // SQL templates
    private static final String _updateSQL = "UPDATE LOGIN_RECORD SET `USER_ID` = ?, `USER_NAME` = ?, `LOGIN_DAY` = ?, `GOT_REWART_DAY` = ?, `LAST_LOGIN_DATE` = ? WHERE `ID` = ?;";
    private static final String _querySQL = "SELECT * FROM LOGIN_RECORD WHERE `ID` = ?;";
    private static final String _createSQL = "INSERT INTO LOGIN_RECORD (`USER_ID`, `USER_NAME`, `LOGIN_DAY`, `GOT_REWART_DAY`, `LAST_LOGIN_DATE`) VALUES (?, ?, ?, ?, ?);";
    private static final String _deleteSQL = "DELETE FROM LOGIN_RECORD WHERE `ID` = ?;";
    ...
    private static HashMap<String, Integer> getFieldMap(){
        if (AttrFieldMap == null){
            ...
            AttrFieldMap.put("LOGIN_DAY", 4);
            AttrFieldMap.put("GOT_REWART_DAY", 5);
            AttrFieldMap.put("LAST_LOGIN_DATE", 6);
        }
    ...
    public static final TableBase.Attribute<Integer> AttrID = new TableBase.Attribute<Integer>("ID", TLoginRecord.class, 1);
    public static final TableBase.Attribute<Integer> AttrUSER_ID = new TableBase.Attribute<Integer>("USER_ID", TLoginRecord.class, 2);
    public static final TableBase.AttributeS AttrUSER_NAME = new TableBase.AttributeS("USER_NAME", TLoginRecord.class, 3);
    public static final TableBase.Attribute<Integer> AttrLOGIN_DAY = new TableBase.Attribute<Integer>("LOGIN_DAY", TLoginRecord.class, 4);
    public static final TableBase.AttributeS AttrGOT_REWART_DAY = new TableBase.AttributeS("GOT_REWART_DAY", TLoginRecord.class, 5);
    public static final TableBase.Attribute<java.util.Date> AttrLAST_LOGIN_DATE = new TableBase.Attribute<java.util.Date>("LAST_LOGIN_DATE", TLoginRecord.class, 6);
    ...
    public int LOGIN_DAY = 0;
    public String GOT_REWART_DAY = "";
    public java.util.Date LAST_LOGIN_DATE = new java.util.Date(0);

    // DON'T Invoke This Method Manually.
    @Override
    public HashMap<String, Integer> _getFieldMap(){
        return TLoginRecord.getFieldMap();
    }
    ...
    public void _setValue(int __fidx, Object __val){
        ...
        case 4: {this.LOGIN_DAY = (Integer)__val; break;}
        case 5: {this.GOT_REWART_DAY = (String)__val; break;}
        case 6: {this.LAST_LOGIN_DATE = (java.util.Date)__val; break;}
        }
    }
    ...
    public Comparable _getValue(int __fidx){
        ...
        case 4: {return this.LOGIN_DAY;}
        case 5: {return this.GOT_REWART_DAY;}
        case 6: {return this.LAST_LOGIN_DATE;}
        }
        return null;
    }
    ...
    */
    ...
    public static ArrayList<TLoginRecord> getAllObjects(){
        ArrayList<Object> __tmp = _tableCache.loadAll();

        ArrayList<TLoginRecord> __res = new ArrayList<TLoginRecord>();
        for (Object __obj: __tmp){
            __res.add((TLoginRecord)__obj);
        }
    ...
    */
    ...
    public boolean update(){
        int __res = _tableCache.update(this, _updateSQL, 
            USER_ID, USER_NAME, LOGIN_DAY, GOT_REWART_DAY, 
            LAST_LOGIN_DATE, ID);
    ...
    */
    public static int updateBatch(TLoginRecord[] objList){
        Object[][] argv = new Object[objList.length][];

        for (int idx = 0; idx < objList.length; idx++){
            TLoginRecord o = objList[idx];
            Object[] args = new Object[]{
                o.USER_ID, o.USER_NAME, o.LOGIN_DAY, o.GOT_REWART_DAY, 
                o.LAST_LOGIN_DATE, o.ID};
    ...
    */
    public static int removeBatch(TLoginRecord[] objList){
        Object argv[] = new Object[objList.length];
    ...
    */
    public static TLoginRecord create(){

        TLoginRecord __newObj = new TLoginRecord();

        return (TLoginRecord) _tableCache.create(__newObj, _createSQL, 
            __newObj.USER_ID, __newObj.USER_NAME, __newObj.LOGIN_DAY, __newObj.GOT_REWART_DAY, 
            __newObj.LAST_LOGIN_DATE);
    }
    ...
    */
    public static TLoginRecord getOne(int ID){
        return (TLoginRecord) _tableCache.getOne(_genKey(ID), _querySQL, ID);
    }
    ...
    * @return the found JPO or null
    */
    public static TLoginRecord getOneByCriteria(QueryCriteria ...criteria){
        return (TLoginRecord)_tableCache.getOneByCriteria(criteria);
    }
    ...
    */
    public static ArrayList<TLoginRecord> getManyByCriteria(QueryCriteria ...criteria){
    ...
    */
    public static TLoginRecord getOneBySQL(String sql, Object ...args){
        return (TLoginRecord)_tableCache.getOneBySQL(sql, args);
    }
    ...
    * @return a list of JPO found.
    */
    public static ArrayList<TLoginRecord> getManyBySQL(String sql, Object ...args){
