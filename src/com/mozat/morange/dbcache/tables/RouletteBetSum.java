...
*
* @Class: RouletteBetSum
* @Namespace: com.mozat.morange.dbcache.tables
* @Table: ROULETTE_BET_SUM
* @Primary Key: ID
* @Identity: ID
* @Unique Index: [u'ID']
*
...
public final class RouletteBetSum extends TableBase implements java.io.Serializable{
    // Serializable ID
    ...
    */
    ...
    // SQL templates
    private static final String _updateSQL = "UPDATE ROULETTE_BET_SUM SET `ROOM_ID` = ?, `ROULETTE_ID` = ?, `RESULT` = ?, `USER_ID` = ?, `USER_NAME` = ?, `BET_TOTAL` = ?, `REWARD_TOTAL` = ?, `RECORD_TIME` = ? WHERE `ID` = ?;";
    private static final String _querySQL = "SELECT * FROM ROULETTE_BET_SUM WHERE `ID` = ?;";
    private static final String _createSQL = "INSERT INTO ROULETTE_BET_SUM (`ROOM_ID`, `ROULETTE_ID`, `RESULT`, `USER_ID`, `USER_NAME`, `BET_TOTAL`, `REWARD_TOTAL`, `RECORD_TIME`) VALUES (?, ?, ?, ?, ?, ?, ?, ?);";
    private static final String _deleteSQL = "DELETE FROM ROULETTE_BET_SUM WHERE `ID` = ?;";
    ...
    private static HashMap<String, Integer> getFieldMap(){
        if (AttrFieldMap == null){
            ...
            AttrFieldMap.put("RESULT", 4);
            AttrFieldMap.put("USER_ID", 5);
            AttrFieldMap.put("USER_NAME", 6);
            AttrFieldMap.put("BET_TOTAL", 7);
            AttrFieldMap.put("REWARD_TOTAL", 8);
            AttrFieldMap.put("RECORD_TIME", 9);
        }
    ...
    public static final TableBase.Attribute<Integer> AttrID = new TableBase.Attribute<Integer>("ID", RouletteBetSum.class, 1);
    public static final TableBase.AttributeS AttrROOM_ID = new TableBase.AttributeS("ROOM_ID", RouletteBetSum.class, 2);
    public static final TableBase.Attribute<Integer> AttrROULETTE_ID = new TableBase.Attribute<Integer>("ROULETTE_ID", RouletteBetSum.class, 3);
    public static final TableBase.Attribute<Integer> AttrRESULT = new TableBase.Attribute<Integer>("RESULT", RouletteBetSum.class, 4);
    public static final TableBase.Attribute<Integer> AttrUSER_ID = new TableBase.Attribute<Integer>("USER_ID", RouletteBetSum.class, 5);
    public static final TableBase.AttributeS AttrUSER_NAME = new TableBase.AttributeS("USER_NAME", RouletteBetSum.class, 6);
    public static final TableBase.Attribute<Integer> AttrBET_TOTAL = new TableBase.Attribute<Integer>("BET_TOTAL", RouletteBetSum.class, 7);
    public static final TableBase.Attribute<Integer> AttrREWARD_TOTAL = new TableBase.Attribute<Integer>("REWARD_TOTAL", RouletteBetSum.class, 8);
    public static final TableBase.Attribute<java.util.Date> AttrRECORD_TIME = new TableBase.Attribute<java.util.Date>("RECORD_TIME", RouletteBetSum.class, 9);
    ...
    public HashMap<String, Integer> _getFieldMap(){
        return RouletteBetSum.getFieldMap();
    }
    ...
    public void _setValue(int __fidx, Object __val){
        ...
        case 4: {this.RESULT = (Integer)__val; break;}
        case 5: {this.USER_ID = (Integer)__val; break;}
        case 6: {this.USER_NAME = (String)__val; break;}
        case 7: {this.BET_TOTAL = (Integer)__val; break;}
        case 8: {this.REWARD_TOTAL = (Integer)__val; break;}
        case 9: {this.RECORD_TIME = (java.util.Date)__val; break;}
        }
    }
    ...
    public Comparable _getValue(int __fidx){
        ...
        case 5: {return this.USER_ID;}
        case 6: {return this.USER_NAME;}
        case 7: {return this.BET_TOTAL;}
        case 8: {return this.REWARD_TOTAL;}
        case 9: {return this.RECORD_TIME;}
        }
        return null;
    }
    ...
    */
    ...
    public static ArrayList<RouletteBetSum> getAllObjects(){
        ArrayList<Object> __tmp = _tableCache.loadAll();

        ArrayList<RouletteBetSum> __res = new ArrayList<RouletteBetSum>();
        for (Object __obj: __tmp){
            __res.add((RouletteBetSum)__obj);
        }
    ...
    */
    ...
    public boolean update(){
        int __res = _tableCache.update(this, _updateSQL, 
            ROOM_ID, ROULETTE_ID, RESULT, USER_ID, 
            USER_NAME, BET_TOTAL, REWARD_TOTAL, RECORD_TIME, 
            ID);
    ...
    */
    public static int updateBatch(RouletteBetSum[] objList){
        Object[][] argv = new Object[objList.length][];

        for (int idx = 0; idx < objList.length; idx++){
            RouletteBetSum o = objList[idx];
            Object[] args = new Object[]{
                o.ROOM_ID, o.ROULETTE_ID, o.RESULT, o.USER_ID, 
                o.USER_NAME, o.BET_TOTAL, o.REWARD_TOTAL, o.RECORD_TIME, 
                o.ID};
    ...
    */
    public static int removeBatch(RouletteBetSum[] objList){
        Object argv[] = new Object[objList.length];
    ...
    */
    public static RouletteBetSum create(){

        RouletteBetSum __newObj = new RouletteBetSum();

        return (RouletteBetSum) _tableCache.create(__newObj, _createSQL, 
            __newObj.ROOM_ID, __newObj.ROULETTE_ID, __newObj.RESULT, __newObj.USER_ID, 
            __newObj.USER_NAME, __newObj.BET_TOTAL, __newObj.REWARD_TOTAL, __newObj.RECORD_TIME);
    }
    ...
    */
    public static RouletteBetSum getOne(int ID){
        return (RouletteBetSum) _tableCache.getOne(_genKey(ID), _querySQL, ID);
    }
    ...
    * @return the found JPO or null
    */
    public static RouletteBetSum getOneByCriteria(QueryCriteria ...criteria){
        return (RouletteBetSum)_tableCache.getOneByCriteria(criteria);
    }
    ...
    */
    public static ArrayList<RouletteBetSum> getManyByCriteria(QueryCriteria ...criteria){
    ...
    */
    public static RouletteBetSum getOneBySQL(String sql, Object ...args){
        return (RouletteBetSum)_tableCache.getOneBySQL(sql, args);
    }
    ...
    * @return a list of JPO found.
    */
    public static ArrayList<RouletteBetSum> getManyBySQL(String sql, Object ...args){
