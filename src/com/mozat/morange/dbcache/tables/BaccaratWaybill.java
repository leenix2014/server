...
*
* @Class: BaccaratWaybill
* @Namespace: com.mozat.morange.dbcache.tables
* @Table: BACCARAT_WAYBILL
* @Primary Key: ID
* @Identity: ID
* @Unique Index: [u'ID']
*
...
public final class BaccaratWaybill extends TableBase implements java.io.Serializable{
    // Serializable ID
    ...
    */
    ...
    // SQL templates
    private static final String _updateSQL = "UPDATE BACCARAT_WAYBILL SET `ROOM_ID` = ?, `LAST_BACC_ID` = ?, `SIZE` = ?, `MAIN_ROAD` = ?, `DISH_ROAD` = ?, `RECORD_TIME` = ? WHERE `ID` = ?;";
    private static final String _querySQL = "SELECT * FROM BACCARAT_WAYBILL WHERE `ID` = ?;";
    private static final String _createSQL = "INSERT INTO BACCARAT_WAYBILL (`ROOM_ID`, `LAST_BACC_ID`, `SIZE`, `MAIN_ROAD`, `DISH_ROAD`, `RECORD_TIME`) VALUES (?, ?, ?, ?, ?, ?);";
    private static final String _deleteSQL = "DELETE FROM BACCARAT_WAYBILL WHERE `ID` = ?;";
    ...
    private static HashMap<String, Integer> getFieldMap(){
        if (AttrFieldMap == null){
            ...
            AttrFieldMap.put("LAST_BACC_ID", 3);
            AttrFieldMap.put("SIZE", 4);
            AttrFieldMap.put("MAIN_ROAD", 5);
            AttrFieldMap.put("DISH_ROAD", 6);
            AttrFieldMap.put("RECORD_TIME", 7);
        }
    ...
    public static final TableBase.Attribute<Integer> AttrID = new TableBase.Attribute<Integer>("ID", BaccaratWaybill.class, 1);
    public static final TableBase.AttributeS AttrROOM_ID = new TableBase.AttributeS("ROOM_ID", BaccaratWaybill.class, 2);
    public static final TableBase.Attribute<Integer> AttrLAST_BACC_ID = new TableBase.Attribute<Integer>("LAST_BACC_ID", BaccaratWaybill.class, 3);
    public static final TableBase.Attribute<Integer> AttrSIZE = new TableBase.Attribute<Integer>("SIZE", BaccaratWaybill.class, 4);
    public static final TableBase.AttributeS AttrMAIN_ROAD = new TableBase.AttributeS("MAIN_ROAD", BaccaratWaybill.class, 5);
    public static final TableBase.AttributeS AttrDISH_ROAD = new TableBase.AttributeS("DISH_ROAD", BaccaratWaybill.class, 6);
    public static final TableBase.Attribute<java.util.Date> AttrRECORD_TIME = new TableBase.Attribute<java.util.Date>("RECORD_TIME", BaccaratWaybill.class, 7);
    ...
    public int LAST_BACC_ID = 0;
    public int SIZE = 0;
    public String MAIN_ROAD = "";
    public String DISH_ROAD = "";
    ...
    public HashMap<String, Integer> _getFieldMap(){
        return BaccaratWaybill.getFieldMap();
    }
    ...
    public void _setValue(int __fidx, Object __val){
        ...
        case 3: {this.LAST_BACC_ID = (Integer)__val; break;}
        case 4: {this.SIZE = (Integer)__val; break;}
        case 5: {this.MAIN_ROAD = (String)__val; break;}
        case 6: {this.DISH_ROAD = (String)__val; break;}
        case 7: {this.RECORD_TIME = (java.util.Date)__val; break;}
        }
    }
    ...
    public Comparable _getValue(int __fidx){
        ...
        case 3: {return this.LAST_BACC_ID;}
        case 4: {return this.SIZE;}
        case 5: {return this.MAIN_ROAD;}
        case 6: {return this.DISH_ROAD;}
        case 7: {return this.RECORD_TIME;}
        }
        return null;
    }
    ...
    */
    ...
    public static ArrayList<BaccaratWaybill> getAllObjects(){
        ArrayList<Object> __tmp = _tableCache.loadAll();

        ArrayList<BaccaratWaybill> __res = new ArrayList<BaccaratWaybill>();
        for (Object __obj: __tmp){
            __res.add((BaccaratWaybill)__obj);
        }
    ...
    */
    ...
    public boolean update(){
        int __res = _tableCache.update(this, _updateSQL, 
            ROOM_ID, LAST_BACC_ID, SIZE, MAIN_ROAD, 
            DISH_ROAD, RECORD_TIME, ID);
    ...
    */
    public static int updateBatch(BaccaratWaybill[] objList){
        Object[][] argv = new Object[objList.length][];

        for (int idx = 0; idx < objList.length; idx++){
            BaccaratWaybill o = objList[idx];
            Object[] args = new Object[]{
                o.ROOM_ID, o.LAST_BACC_ID, o.SIZE, o.MAIN_ROAD, 
                o.DISH_ROAD, o.RECORD_TIME, o.ID};
    ...
    */
    public static int removeBatch(BaccaratWaybill[] objList){
        Object argv[] = new Object[objList.length];
    ...
    */
    public static BaccaratWaybill create(){

        BaccaratWaybill __newObj = new BaccaratWaybill();

        return (BaccaratWaybill) _tableCache.create(__newObj, _createSQL, 
            __newObj.ROOM_ID, __newObj.LAST_BACC_ID, __newObj.SIZE, __newObj.MAIN_ROAD, 
            __newObj.DISH_ROAD, __newObj.RECORD_TIME);
    }
    ...
    */
    public static BaccaratWaybill getOne(int ID){
        return (BaccaratWaybill) _tableCache.getOne(_genKey(ID), _querySQL, ID);
    }
    ...
    * @return the found JPO or null
    */
    public static BaccaratWaybill getOneByCriteria(QueryCriteria ...criteria){
        return (BaccaratWaybill)_tableCache.getOneByCriteria(criteria);
    }
    ...
    */
    public static ArrayList<BaccaratWaybill> getManyByCriteria(QueryCriteria ...criteria){
    ...
    */
    public static BaccaratWaybill getOneBySQL(String sql, Object ...args){
        return (BaccaratWaybill)_tableCache.getOneBySQL(sql, args);
    }
    ...
    * @return a list of JPO found.
    */
    public static ArrayList<BaccaratWaybill> getManyBySQL(String sql, Object ...args){
