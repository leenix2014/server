...
public final class AnchorBill extends TableBase implements java.io.Serializable{
    // Serializable ID
    ...
    */
    ...
    // SQL templates
    private static final String _updateSQL = "UPDATE ANCHOR_BILL SET `ANCHOR_ID` = ?, `ANCHOR_NAME` = ?, `ANCHOR_TYPE` = ?, `BILL_TYPE` = ?, `ROOM_ID` = ?, `CHANNEL` = ?, `USER_ID` = ?, `USER_NAME` = ?, `AMOUNT` = ?, `RECORD_TIME` = ? WHERE `ID` = ?;";
    private static final String _querySQL = "SELECT * FROM ANCHOR_BILL WHERE `ID` = ?;";
    private static final String _createSQL = "INSERT INTO ANCHOR_BILL (`ANCHOR_ID`, `ANCHOR_NAME`, `ANCHOR_TYPE`, `BILL_TYPE`, `ROOM_ID`, `CHANNEL`, `USER_ID`, `USER_NAME`, `AMOUNT`, `RECORD_TIME`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?);";
    private static final String _deleteSQL = "DELETE FROM ANCHOR_BILL WHERE `ID` = ?;";
    ...
    private static HashMap<String, Integer> getFieldMap(){
        if (AttrFieldMap == null){
            ...
            AttrFieldMap.put("BILL_TYPE", 5);
            AttrFieldMap.put("ROOM_ID", 6);
            AttrFieldMap.put("CHANNEL", 7);
            AttrFieldMap.put("USER_ID", 8);
            AttrFieldMap.put("USER_NAME", 9);
            AttrFieldMap.put("AMOUNT", 10);
            AttrFieldMap.put("RECORD_TIME", 11);
        }
    ...
    public static final TableBase.Attribute<Integer> AttrID = new TableBase.Attribute<Integer>("ID", AnchorBill.class, 1);
    public static final TableBase.Attribute<Integer> AttrANCHOR_ID = new TableBase.Attribute<Integer>("ANCHOR_ID", AnchorBill.class, 2);
    public static final TableBase.AttributeS AttrANCHOR_NAME = new TableBase.AttributeS("ANCHOR_NAME", AnchorBill.class, 3);
    public static final TableBase.AttributeS AttrANCHOR_TYPE = new TableBase.AttributeS("ANCHOR_TYPE", AnchorBill.class, 4);
    public static final TableBase.AttributeS AttrBILL_TYPE = new TableBase.AttributeS("BILL_TYPE", AnchorBill.class, 5);
    public static final TableBase.Attribute<Integer> AttrROOM_ID = new TableBase.Attribute<Integer>("ROOM_ID", AnchorBill.class, 6);
    public static final TableBase.AttributeS AttrCHANNEL = new TableBase.AttributeS("CHANNEL", AnchorBill.class, 7);
    public static final TableBase.Attribute<Integer> AttrUSER_ID = new TableBase.Attribute<Integer>("USER_ID", AnchorBill.class, 8);
    public static final TableBase.AttributeS AttrUSER_NAME = new TableBase.AttributeS("USER_NAME", AnchorBill.class, 9);
    public static final TableBase.Attribute<Integer> AttrAMOUNT = new TableBase.Attribute<Integer>("AMOUNT", AnchorBill.class, 10);
    public static final TableBase.Attribute<java.util.Date> AttrRECORD_TIME = new TableBase.Attribute<java.util.Date>("RECORD_TIME", AnchorBill.class, 11);
    ...
    public void _setValue(int __fidx, Object __val){
        ...
        case 5: {this.BILL_TYPE = (String)__val; break;}
        case 6: {this.ROOM_ID = (Integer)__val; break;}
        case 7: {this.CHANNEL = (String)__val; break;}
        case 8: {this.USER_ID = (Integer)__val; break;}
        case 9: {this.USER_NAME = (String)__val; break;}
        case 10: {this.AMOUNT = (Integer)__val; break;}
        case 11: {this.RECORD_TIME = (java.util.Date)__val; break;}
        }
    }
    ...
    public Comparable _getValue(int __fidx){
        ...
        case 5: {return this.BILL_TYPE;}
        case 6: {return this.ROOM_ID;}
        case 7: {return this.CHANNEL;}
        case 8: {return this.USER_ID;}
        case 9: {return this.USER_NAME;}
        case 10: {return this.AMOUNT;}
        case 11: {return this.RECORD_TIME;}
        }
        return null;
    }
    ...
    */
    ...
    public static ArrayList<AnchorBill> getAllObjects(){
        ArrayList<Object> __tmp = _tableCache.loadAll();

        ArrayList<AnchorBill> __res = new ArrayList<AnchorBill>();
        for (Object __obj: __tmp){
            __res.add((AnchorBill)__obj);
        }
    ...
    */
    ...
    public boolean update(){
        int __res = _tableCache.update(this, _updateSQL, 
            ANCHOR_ID, ANCHOR_NAME, ANCHOR_TYPE, BILL_TYPE, 
            ROOM_ID, CHANNEL, USER_ID, USER_NAME, 
    ...
    */
    public static int updateBatch(AnchorBill[] objList){
        Object[][] argv = new Object[objList.length][];

        for (int idx = 0; idx < objList.length; idx++){
            AnchorBill o = objList[idx];
            Object[] args = new Object[]{
                o.ANCHOR_ID, o.ANCHOR_NAME, o.ANCHOR_TYPE, o.BILL_TYPE, 
                o.ROOM_ID, o.CHANNEL, o.USER_ID, o.USER_NAME, 
                o.AMOUNT, o.RECORD_TIME, o.ID};
    ...
    */
    public static int removeBatch(AnchorBill[] objList){
        Object argv[] = new Object[objList.length];
    ...
    */
    public static AnchorBill create(){

        AnchorBill __newObj = new AnchorBill();

        return (AnchorBill) _tableCache.create(__newObj, _createSQL, 
            __newObj.ANCHOR_ID, __newObj.ANCHOR_NAME, __newObj.ANCHOR_TYPE, __newObj.BILL_TYPE, 
            __newObj.ROOM_ID, __newObj.CHANNEL, __newObj.USER_ID, __newObj.USER_NAME, 
            __newObj.AMOUNT, __newObj.RECORD_TIME);
    }
    ...
    */
    public static AnchorBill getOne(int ID){
        return (AnchorBill) _tableCache.getOne(_genKey(ID), _querySQL, ID);
    }
    ...
    * @return the found JPO or null
    */
    public static AnchorBill getOneByCriteria(QueryCriteria ...criteria){
        return (AnchorBill)_tableCache.getOneByCriteria(criteria);
    }
    ...
    */
    public static ArrayList<AnchorBill> getManyByCriteria(QueryCriteria ...criteria){
    ...
    */
    public static AnchorBill getOneBySQL(String sql, Object ...args){
        return (AnchorBill)_tableCache.getOneBySQL(sql, args);
    }
    ...
    * @return a list of JPO found.
    */
    public static ArrayList<AnchorBill> getManyBySQL(String sql, Object ...args){
