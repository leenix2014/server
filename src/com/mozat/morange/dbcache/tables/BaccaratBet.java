...
public final class BaccaratBet extends TableBase implements java.io.Serializable{
    // Serializable ID
    ...
    */
    ...
    // SQL templates
    private static final String _updateSQL = "UPDATE BACCARAT_BET SET `ROOM_ID` = ?, `BACCARAT_ID` = ?, `USER_ID` = ?, `USER_NAME` = ?, `BET_ON` = ?, `BET_COUNT` = ?, `REWARD` = ?, `BET_TIME` = ? WHERE `ID` = ?;";
    private static final String _querySQL = "SELECT * FROM BACCARAT_BET WHERE `ID` = ?;";
    private static final String _createSQL = "INSERT INTO BACCARAT_BET (`ROOM_ID`, `BACCARAT_ID`, `USER_ID`, `USER_NAME`, `BET_ON`, `BET_COUNT`, `REWARD`, `BET_TIME`) VALUES (?, ?, ?, ?, ?, ?, ?, ?);";
    private static final String _deleteSQL = "DELETE FROM BACCARAT_BET WHERE `ID` = ?;";
    ...
    private static HashMap<String, Integer> getFieldMap(){
        if (AttrFieldMap == null){
            ...
            AttrFieldMap.put("BACCARAT_ID", 3);
    ...
    public static final TableBase.Attribute<Integer> AttrID = new TableBase.Attribute<Integer>("ID", BaccaratBet.class, 1);
    public static final TableBase.AttributeS AttrROOM_ID = new TableBase.AttributeS("ROOM_ID", BaccaratBet.class, 2);
    public static final TableBase.Attribute<Integer> AttrBACCARAT_ID = new TableBase.Attribute<Integer>("BACCARAT_ID", BaccaratBet.class, 3);
    public static final TableBase.Attribute<Integer> AttrUSER_ID = new TableBase.Attribute<Integer>("USER_ID", BaccaratBet.class, 4);
    public static final TableBase.AttributeS AttrUSER_NAME = new TableBase.AttributeS("USER_NAME", BaccaratBet.class, 5);
    public static final TableBase.AttributeS AttrBET_ON = new TableBase.AttributeS("BET_ON", BaccaratBet.class, 6);
    public static final TableBase.Attribute<Integer> AttrBET_COUNT = new TableBase.Attribute<Integer>("BET_COUNT", BaccaratBet.class, 7);
    public static final TableBase.Attribute<Integer> AttrREWARD = new TableBase.Attribute<Integer>("REWARD", BaccaratBet.class, 8);
    public static final TableBase.Attribute<java.util.Date> AttrBET_TIME = new TableBase.Attribute<java.util.Date>("BET_TIME", BaccaratBet.class, 9);
    ...
    public HashMap<String, Integer> _getFieldMap(){
        return BaccaratBet.getFieldMap();
    }
    ...
    public void _setValue(int __fidx, Object __val){
        ...
        case 3: {this.BACCARAT_ID = (Integer)__val; break;}
    ...
    public Comparable _getValue(int __fidx){
        ...
        case 3: {return this.BACCARAT_ID;}
    ...
    */
    ...
    public static ArrayList<BaccaratBet> getAllObjects(){
        ArrayList<Object> __tmp = _tableCache.loadAll();

        ArrayList<BaccaratBet> __res = new ArrayList<BaccaratBet>();
        for (Object __obj: __tmp){
            __res.add((BaccaratBet)__obj);
        }
    ...
    */
    ...
    public boolean update(){
        int __res = _tableCache.update(this, _updateSQL, 
            ROOM_ID, BACCARAT_ID, USER_ID, USER_NAME, 
    ...
    */
    public static int updateBatch(BaccaratBet[] objList){
        Object[][] argv = new Object[objList.length][];

        for (int idx = 0; idx < objList.length; idx++){
            BaccaratBet o = objList[idx];
            Object[] args = new Object[]{
                o.ROOM_ID, o.BACCARAT_ID, o.USER_ID, o.USER_NAME, 
    ...
    */
    public static int removeBatch(BaccaratBet[] objList){
        Object argv[] = new Object[objList.length];
    ...
    */
    public static BaccaratBet create(){

        BaccaratBet __newObj = new BaccaratBet();

        return (BaccaratBet) _tableCache.create(__newObj, _createSQL, 
            __newObj.ROOM_ID, __newObj.BACCARAT_ID, __newObj.USER_ID, __newObj.USER_NAME, 
    ...
    */
    public static BaccaratBet getOne(int ID){
        return (BaccaratBet) _tableCache.getOne(_genKey(ID), _querySQL, ID);
    }
    ...
    * @return the found JPO or null
    */
    public static BaccaratBet getOneByCriteria(QueryCriteria ...criteria){
        return (BaccaratBet)_tableCache.getOneByCriteria(criteria);
    }
    ...
    */
    public static ArrayList<BaccaratBet> getManyByCriteria(QueryCriteria ...criteria){
    ...
    */
    public static BaccaratBet getOneBySQL(String sql, Object ...args){
        return (BaccaratBet)_tableCache.getOneBySQL(sql, args);
    }
    ...
    * @return a list of JPO found.
    */
    public static ArrayList<BaccaratBet> getManyBySQL(String sql, Object ...args){
